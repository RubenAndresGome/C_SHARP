...
namespace Backend.Controllers
{
    ...
    public class RandomController : ControllerBase
    {
            ...
            public ActionResult<Dictionary<string,int> > Get() 
        {
            ...
            result.Add("Singleton 1", _randomService2Singleton.Value);
            result.Add("Scoped 1", _randomService2Scoped.Value);
            result.Add("Transient 1", _randomService2Transient.Value);
